...
const inprotainInput     = document.getElementById("inprotain")  as HTMLInputElement;
const gramInput    = document.getElementById("gram") as HTMLInputElement;
const searchInput  = document.getElementById("search") as HTMLInputElement;
const protainList    =document.getElementById("protain-list")as HTMLDivElement;
...
if(savedProtains){
    ...
    function renderProtain(displayProtains:ProtainType[]=Protains){
